"""Advent of Code 2015 Day 1 - Parentheses Floor Counter."""
...
def solve(data: str) -> tuple[int, int]:
    """
    Solve Day 1 puzzle for both parts.
    ...
    return sum(moves), next(
        (i for i, v in enumerate(accumulate(moves), 1) if v == -1), -1
    )


class TestDay1(unittest.TestCase):
    """Verify solve logic against puzzle examples."""
